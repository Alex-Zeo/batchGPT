...
from src.services.events import BatchEventEmitter
...
class BatchManager:
    ...
    def __init__(self, storage_dir: str = None, observer: BatchEventEmitter | None = None):
    ...
    def add_batch(self, batch_id: str, batch_info: Union[Dict, BatchJob]) -> None:
        ...
        if self.observer:
            self.observer.notify(batch_id, batch_job.status)
